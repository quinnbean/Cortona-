...
def login():
    if request.method == 'POST':
        ...
        if is_account_locked(u):
            return render_template_string(LOGIN_PAGE, error='Account temporarily locked. Try again in 15 minutes.')
        ...
        if remaining <= 2:
            return render_template_string(LOGIN_PAGE, error=f'Invalid credentials. {remaining} attempts remaining.')
