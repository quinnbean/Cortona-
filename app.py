...
╠══════════════════════════════════════════════════════════════════════════════╣
║                                                                              ║
║  STEP 1: UPLOAD THIS FILE TO GITHUB                                         ║
║  ─────────────────────────────────────                                       ║
║  1. Go to github.com and sign in (or create account)                         ║
║  2. Click the "+" in top right → "New repository"                            ║
║  3. Name it "voice-hub" → Click "Create repository"                          ║
║  4. Click "uploading an existing file"                                       ║
║  5. Drag THIS FILE (app.py) into the upload box                              ║
...
║  4. Select your "voice-hub" repo                                             ║
║  5. Wait 2-3 minutes for it to deploy                                        ║
║  6. Click on your service → "Settings" → "Generate Domain"                   ║
║  7. You'll get a URL like: https://voice-hub-xxx.up.railway.app              ║
║                                                                              ║
║  STEP 3: SET YOUR PASSWORD (Optional but recommended)                        ║
║  ─────────────────────────────────────────────────────                       ║
║  1. In Railway, click your service → "Variables"                             ║
║  2. Click "New Variable"                                                     ║
║  3. Name: ADMIN_PASSWORD  Value: your_secret_password                        ║
║                                                                              ║
║  STEP 4: ACCESS YOUR DASHBOARD                                               ║
║  ─────────────────────────────────                                           ║
║  Open your Railway URL in any browser!                                       ║
║  Login: admin / voicehub123 (or your custom password)                        ║
║                                                                              ║
║  STEP 5: CONNECT YOUR COMPUTERS                                              ║
║  ─────────────────────────────────                                           ║
║  The dashboard will show you the exact command to run on each computer.      ║
║  Just download the voice_client.py from the dashboard and run it!            ║
║                                                                              ║
╚══════════════════════════════════════════════════════════════════════════════╝

This single file contains EVERYTHING needed:
- Web server with login
- Real-time dashboard  
- WebSocket support for voice clients
- Downloadable voice client script

Default login: admin / voicehub123
"""
